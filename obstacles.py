...
class Normalizer:
    ...
    def normalize(self, inputs):
        obs_std = np.sqrt(self.var + 1e-8) # FIX: Ensure positive inside sqrt
...
class PPOAgent:
    ...
    def update(self):
        ...
        # FIX: Safe Normalization to prevent NaN
        if rewards.std() > 1e-5:
...
class NovelPPO_PSO:
    ...
    def get_state(self, i):
        # State: [Progress, Distance to Goal, Diversity]
    ...
    def run(self):
        ...
        for i in tqdm(range(self.max_iter), desc="Novel PPO-PSO"):
            ...
            # Reward: Improvement in Goal Distance + Penalty Avoidance
...
def run_comparison():
    ...
    print("Saved simulation plot to 'swarm_obstacle_avoidance.png'")
